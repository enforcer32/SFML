...
int main()
{
    ...
    sf::Text playbackDevice(font, "Current playback device: " + sf::PlaybackDevice::getDevice(), 20);
            ...
            if (const auto* keyPressed = event.getIf<sf::Event::KeyPressed>())
            {
                switch (keyPressed->code)
                {
                    ...
                    case sf::Keyboard::Key::F1:
                    {
                        ...
                        playbackDevice.setString("Current playback device: " + sf::PlaybackDevice::getDevice());
